                    ...
                    {hasSummary && (
                      <span className="session-item-stats">
                        <span className="session-item-files">
                          <svg width="10" height="10" viewBox="0 0 16 16" fill="currentColor"><path d="M13.71 4.29l-3-3A1 1 0 0010 1H4a1 1 0 00-1 1v12a1 1 0 001 1h8a1 1 0 001-1V5a1 1 0 00-.29-.71zM12 14H4V2h5v3a1 1 0 001 1h3v8z"/></svg>
                          {summary.files}
                        </span>
